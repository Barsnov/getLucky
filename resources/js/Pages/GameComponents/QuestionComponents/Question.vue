...
<template>
    <div class="absolute bg-[#bde0ff] w-full h-full flex flex-col items-start justify-center gap-10 transition-all duration-1000" :class="visibleQuestion ? 'opacity-100 z-30' : 'opacity-0 -z-10'">
        ...
        <h1 class="absolute text-gray-800 left-7 top-8 text-3xl text-center font-medium" style="font-family: 'Barboskin', serif">
            Категория:
            <span style="font-family: 'Barboskin', serif" class="text-gray-900 font-bold text-4xl underline-offset-4 underline uppercase">Карточка "Внимание, вопрос!"</span>
        </h1>
        ...
        <div class="flex w-10/12 justify-center">
            <div class="w-11/12 flex flex-col items-center justify-center gap-1">
                ...
                <div :class="checkAnswer ? 'opacity-100 relative' : 'opacity-0 absolute -z-10'" style="font-family: 'RobotoCondensed', sans-serif;" class="text-[1.8rem] text-justify font-bold border-black/80 bg-gray-100 border-[.2rem] px-10 py-3 rounded-lg break-words">Ответ: <span style="font-family: 'RobotoCondensed', sans-serif;" class="font-normal">{{question.answer}}</span></div>
