...
const create = () => {
    emit('createNew', 'Decide')
}
const update = (item) => {
    emit('update', item, 'Decide')
    openMenuIndex.value = false;
}
const del = (item) => {
    emit('del', item, 'Decide')
    openMenuIndex.value = false;
}
...
<template>
    ...
    <div class="w-full h-max relative flex flex-col gap-4">
        <h2 class="ms-8 font-bold text-4xl w-full text-gray-800">Карточки "Решай-ка"</h2>
        <div class="w-full h-max bg-white rounded-xl px-8 py-12 mt-10">
            <div class="flex justify-between border-b-2 border-gray-200 pb-6">
                <div
                    ...
                    <p class="text-sm -ms-1 -mb-0.5 font-medium">Добавить карточку "Решай-ка"</p>
                    <ChevronUpIcon
            ...
            <div class="mt-10">
                ...
                <div v-else class="w-full">
                    <div v-if="content.length === 0">
                        <h2 class="font-bold text-lg text-gray-600 text-center">В данный момент не создано ни одной карточки "Решай-ка"</h2>
                    </div>
                    ...
                    <table v-else
                        ...
                        <tr class="bg-gray-700 text-xl">
                            ...
                            <th class="roboto font-normal w-3/12 text-white px-5 py-4">Дополнение к ответу</th>
                        ...
                        <tr v-for="(item, index) in contentComputed" :key="item.id"
                            ...
                            <td class="border-gray-800 px-5 py-3">
                                <h2 class="text-lg font-bold text-gray-800">{{item.answer}}</h2>
                            </td>
                            <td class="border-gray-800 px-5 py-3">
