                ...
                <div v-else class="w-full">
                    ...
                    <table v-else class="shadow-xl rounded-xl w-full text-left border-gray-800 table-auto border-collapse">
                        ...
                        <tr class="bg-gray-700 text-xl">
                            ...
                            <th class="w-1/12 text-white px-1 py-3">Ответ</th>
                            <th class="w-4/12 text-white px-1 py-3">Дополнение к ответу</th>
                            <th class="w-1/12 text-white px-1 py-3">Кол-во очков</th>
                            <th class="w-1/12 text-white px-1 py-3">Последнее изменение</th>
                            <th class="w-1/12 text-white rounded-se-xl px-5 py-3"></th>
                        </tr>
                        </thead>
                        <tbody>
