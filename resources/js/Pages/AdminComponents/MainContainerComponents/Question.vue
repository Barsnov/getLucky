                ...
                <div v-else class="w-full">
                    ...
                    <table v-else
                        ...
                        <tr class="bg-gray-700 text-xl">
                            <th class="w-4/12 text-white rounded-ss-xl px-5 py-4">Вопрос</th>
                            <th class="w-1/12 text-white px-5 py-4">Ответ</th>
                            <th class="w-4/12 text-white px-5 py-4">Дополнение к ответу</th>
                            <th class="w-1/12 text-white px-5 py-4">Кол-во очков</th>
