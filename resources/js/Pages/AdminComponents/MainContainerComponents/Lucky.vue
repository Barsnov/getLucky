                ...
                <div v-else class="w-full">
                    ...
                    <table v-else class="shadow-xl rounded-xl w-full text-left border-gray-800 table-auto border-collapse">
                        ...
                        <tr class="bg-gray-700 text-xl">
                            <th class="w-3/12 text-white rounded-ss-xl px-5 py-4">Кол-во очков</th>
                            <th class="w-5/12 text-white px-5 py-4">Последнее изменение</th>
                            <th class="w-2/12 text-white rounded-se-xl px-5 py-4"></th>
                        </tr>
                        </thead>
                        <tbody>
